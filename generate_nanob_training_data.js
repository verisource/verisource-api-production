/**
 * VeriSource — Imagen 3 / Nano Banana Training Data Generator
 ...
 * Run on RunPod: node generate_nanob_training_data.js
 *
 * Get API key at: aistudio.google.com/apikey
 * Usage: GOOGLE_API_KEY=your_key node generate_nanob_training_data.js
 */
...
const PROMPTS = [
  ...
  // Realistic portraits
  'Photorealistic portrait photo of a middle-aged man in business casual clothing, neutral expression, office background',
...
async function main() {
  if (GOOGLE_API_KEY === 'YOUR_GOOGLE_API_KEY_HERE') {
    console.error('❌ Set your Google API key: GOOGLE_API_KEY=your_key node generate_nanob_training_data.js');
    console.error('   Get a free key at: aistudio.google.com/apikey');
    process.exit(1);
  }
  ...
  console.log(`Imagen 3 / Nano Banana Portrait Generator`);
